	...
	<header id="masthead" class="site-header" role="banner">
		...
		<?php if ( get_theme_mod( 'tinyforge_logo' ) ) : ?>
			...
			<div class="site-branding" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="site-title-wrapper" style="width:98 px;">

					<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>

					<h2 class="site-description" ><?php bloginfo( 'description' ); ?></h2>

<!--Kode zati honen bidez qtranslateren widget-a goiburuan erakutsiko da, tinyforge-logo jarrita dagoenean-->
...
<!--Kode zati honen bidez qtranslateren widget-a goiburuan erakutsiko da, tinyforge-logo jarrita ez dagoenean-->
